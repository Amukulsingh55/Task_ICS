...
public class ComparableExample {
    public static void main(String[] args) {
        Employeee employee1 = new Employeee(341, "John", 35000.00);
        Employeee employee2 = new Employeee(103, "Sam", 30000.00);
        Employeee employee3 = new Employeee(221, "Albert", 40000.00);
...
class Employeee implements Comparable<Employeee> {
    ...
    String name;
    Double salary;
    Employeee(Integer employeeId, String name, Double salary) {
